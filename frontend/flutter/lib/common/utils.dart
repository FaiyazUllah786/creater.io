...
Future<File?> pickImageFromUnsplash(String unsplashImageUrl, String photoId,
    Function(double) onProgress) async {
  final imageFile = await UnsplashProvider()
      .downloadAndSaveImage(unsplashImageUrl, photoId, onProgress);
  if (imageFile == null) {
    return null;
  }
  return imageFile;
